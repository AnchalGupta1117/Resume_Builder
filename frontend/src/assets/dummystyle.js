export const landingPageStyles = {
  ...
  secondaryButton:
    "px-8 sm:px-10 py-3 sm:py-4 border-2 border-violet-200 text-violet-700 font-bold rounded-2xl hover:border-violet-300 hover:bg-violet-50 transition-all bg-white",
...
export const cardStyles = {
  ...
  profileCard:
    "flex items-center p-2 sm:p-3 bg-white backdrop-blur-xl border border-gray-200 rounded-2xl shadow-md hover:shadow-lg transition-all duration-300 hover:scale-[1.03]",
  ...
  profileName: "mt-1 text-xs sm:text-sm font-bold text-gray-800",
...
export const authStyles = {
  ...
  container:
    "min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-100 via-violet-100 to-violet-200 relative overflow-hidden p-4 sm:px-6 lg:px-8",
