    ...
    <div className="max-w-7xl mx-auto px-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 lg:gap-8 items-start">
        <div className="lg:col-span-2 bg-white rounded-2xl border border-gray-100 p-4 sm:p-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-h-[60vh] overflow-y-auto overflow-x-hidden p-2">
        ...
        {/* RIGHT AREA*/}
        <div
          className="lg:col-span-3 bg-white rounded-2xl border border-gray-100"
          ref={resumeRef}
        >
          <RenderResume
