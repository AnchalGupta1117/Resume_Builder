        ...
        {thumbnailImg ? (
          <div className="relative w-full h-full overflow-hidden">
            <img src={thumbnailImg || './placeholder.svg' }alt="template Review"
             ...
             <div className="absolute inset-0 bg-gradient-to-r from-white/00 via-transparent to-transparent opacity-0 group-hover:opacity duration-300"/>
             {isSelected && (
             ...
             {/*HOVER EFFECT */}
             <div className="absolute inset-0 bg-gradient-to-t from-violet-100/30 to-transparent opacity-0 group-hover:opacity-100 tracking-opacity duration-300">
             </div>
            </div>
        ):(
