...
//TAKE BACK TO PREVIOUS FORM STATES OR TAKE BACK TO FIRST OR TO /DASHBOARD
  const goBack = () => {
    const pages = [
      "profile-info",
      "contact-info",
...
const uploadResumeImages = async () => {
  ...
  //THIS FUNCTION WILL HELP IN UPDATING THE RESUMES. AND PUT WILL HELP IN UPDATION ON BACKEND(SERVER SIDE)
  ...
  const downloadPDF = async () => {
    ...
    try {
      await html2pdf()
        ...
        .from(element)
        .save();//SAVE THE RESUME HERE AND THEN WE DOWNLOAD IT ...
  ...
  //SO ALL THESE FUNCTION WILL USED IN EDIT RESUME.
