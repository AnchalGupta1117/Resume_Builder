...
const Modal = ({
    ...
    return (
        <div className={styles.overlay + " fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50"}>
            <div className={styles.modalContainer + " bg-blue-50 rounded-lg shadow-lg relative w-full max-w-md p-6"}>
